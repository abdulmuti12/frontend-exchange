      ...
      <div className="mx-auto flex min-h-screen max-w-5xl flex-col px-6 py-10 sm:px-10">
        ...
        <div className="flex flex-1 flex-col items-start justify-center gap-10 py-16 lg:flex-row lg:items-center lg:justify-between lg:gap-6">
          <div className="max-w-xl">
            ...
            <h1 className="font-display text-4xl font-display leading-[1.1] text-ink sm:text-5xl">
              Furnitur lama Anda,
              <br />
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-sm border border-teak bg-teak px-5 py-3 text-sm font-display text-surface transition-colors hover:bg-teak-deep"
              >
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-sm border border-ink/30 px-5 py-3 text-sm font-display text-ink transition-colors hover:border-ink hover:bg-ink/5"
              >
          ...
          <div className="w-full max-w-sm shrink-0 rounded-md border border-line bg-surface shadow-sm">
            ...
            <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-3 px-5 py-6">
              <div>
                ...
                <p className="font-display text-sm font-display text-ink">Kursi Kayu Jati</p>
              </div>
              <Repeat className="size-4 text-teak" />
              <div className="text-right">
                <p className="text-[11px] text-ink-soft">Dari katalog</p>
                <p className="font-display text-sm font-display text-ink">Sofa IKEA Friheten</p>
              </div>
            </div>
