    ...
    <div>
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        {tiles.map((t) => (
          <div key={t.label} className="rounded-md border border-line bg-surface p-5">
            ...
            <p className="mt-3 font-display text-3xl font-display text-ink">{t.value}</p>
      ...
      <div className="mt-6 rounded-md border border-line bg-surface p-6">
        <div className="mb-5 flex items-center justify-between">
          <h2 className="font-display text-lg font-display text-ink">
            ...
            return (
              <div key={status}>
                <div className="mb-1.5 flex items-center justify-between text-sm">
                  <span className="font-display text-ink">{meta.label}</span>
