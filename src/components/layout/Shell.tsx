            ...
            {nav.map((item) => {
              ...
              return (
                <Link
                  ...
                  className={cn(
                    "flex items-center gap-3 rounded-sm px-3 py-2.5 text-sm font-display transition-colors",
                    active
            ...
            <div className="border-t border-line px-3 py-4">
              <div className="flex items-center justify-between gap-2 rounded-sm px-3 py-2">
                <div className="min-w-0">
                  <p className="truncate text-sm font-display text-ink">{identity.name}</p>
